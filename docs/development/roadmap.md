...
Good preset/workflow discipline and depfile support.
...
Still open: `unordered_map`/`unordered_set` appear in 10 codegen files (iteration-order determinism risk, only partly covered by determinism tests).
