...
Integration test names scanned: `174`
Test-source scan: `ctest --test-dir build/matrix/dev-homebrew`
Gating mode: **structural** — coverage is inferred from registered test names. Supply `--ctest-junit` for behavioral (executed pass/fail) gating.
