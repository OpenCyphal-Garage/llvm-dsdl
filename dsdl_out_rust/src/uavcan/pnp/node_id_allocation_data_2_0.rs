...
// Source: uavcan.pnp.NodeIDAllocationData.2.0
...
pub struct uavcan_pnp_NodeIDAllocationData {
...
impl Default for uavcan_pnp_NodeIDAllocationData {
    fn default() -> Self {
        Self {
...
impl uavcan_pnp_NodeIDAllocationData {
    pub const FULL_NAME: &'static str = "uavcan.pnp.NodeIDAllocationData";
    pub const IS_DEPRECATED: bool = false;
    pub const FULL_NAME_AND_VERSION: &'static str = "uavcan.pnp.NodeIDAllocationData.2.0";
    pub const EXTENT_BYTES: usize = 48;
    pub const SERIALIZATION_BUFFER_SIZE_BYTES: usize = 18;
    ...
    pub fn serialize(&self, buffer: &mut [u8]) -> core::result::Result<usize, i8> {
        ...
        let mlir_llvmdsdl_plan_capacity_check__uavcan_pnp_NodeIDAllocationData_2_0 = |capacity_bits: i64| -> i8 {
            if 144i64 > capacity_bits {
                -crate::dsdl_runtime::DSDL_RUNTIME_ERROR_SERIALIZATION_BUFFER_TOO_SMALL
            } else {
                crate::dsdl_runtime::DSDL_RUNTIME_SUCCESS
            }
        };
        let mlir_llvmdsdl_plan_scalar_unsigned__uavcan_pnp_NodeIDAllocationData_2_0__2__ser = |value: u64| -> u64 { if value > 255u64 { 255u64 } else { value } };
        let _err_capacity = mlir_llvmdsdl_plan_capacity_check__uavcan_pnp_NodeIDAllocationData_2_0(buffer.len().saturating_mul(8) as i64);
        ...
        let _err2_ = self.node_id.serialize(&mut buffer[_start.._end]);
        match _err2_ {
        ...
        for _index3_ in 0..16usize {
            let _err4_ = crate::dsdl_runtime::set_uxx(buffer, offset_bits, mlir_llvmdsdl_plan_scalar_unsigned__uavcan_pnp_NodeIDAllocationData_2_0__2__ser(self.unique_id[_index3_] as u64), 8u8);
    ...
    pub fn deserialize(&mut self, buffer: &[u8]) -> core::result::Result<usize, i8> {
        ...
        let mut offset_bits: usize = 0;
        let mlir_llvmdsdl_plan_scalar_unsigned__uavcan_pnp_NodeIDAllocationData_2_0__2__deser = |value: u64| -> u64 { value & 255u64 };
        ...
        if Self::__LLVMDSDL_MEMORY_MODE == crate::dsdl_runtime::DsdlMemoryMode::InlineThenPool {
            ...
            if let Err(_alloc_err) = self.unique_id.reserve_with_pool(_count7_, &mut _pool) {
                return Err(-crate::dsdl_runtime::allocation_error_to_runtime_code(_alloc_err));
            }
        } else {
            self.unique_id.reserve(_count7_);
        }
        for _index8_ in 0.._count7_ {
            let mut _item9_ = 0;
            let _raw10_ = crate::dsdl_runtime::get_u8(buffer, offset_bits, 8u8) as u64;
            _item9_ = mlir_llvmdsdl_plan_scalar_unsigned__uavcan_pnp_NodeIDAllocationData_2_0__2__deser(_raw10_) as u8;
            offset_bits += 8;
            self.unique_id.push(_item9_);
        }
        offset_bits = (offset_bits + 7) & !7usize;
