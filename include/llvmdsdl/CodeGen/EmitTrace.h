...
/// (Python) performs the same ordered sequence of
...
/// docs/reference/codegen/emit-order.md.
///
...
/// @brief One abstract emit operation. Names mirror docs/reference/codegen/emit-order.md.
///
...
public:
    ...
    /// @return Ordered events for this (type, direction); the sequence the emit-order verifier compares across
    /// backends.
    const std::vector<EmitTraceEvent>& events() const
    {
        return events_;
    }
...
inline const char* emitTraceOpName(const EmitTraceOp op)
{
    switch (op)
    {
    case EmitTraceOp::ValidateTag:
        return "VALIDATE_TAG";
    case EmitTraceOp::MaskTag:
        return "MASK_TAG";
    case EmitTraceOp::WriteTag:
        return "WRITE_TAG";
    case EmitTraceOp::ReadTag:
        return "READ_TAG";
    case EmitTraceOp::StoreTag:
        return "STORE_TAG";
    case EmitTraceOp::Switch:
        return "SWITCH";
    case EmitTraceOp::Case:
        return "CASE";
    case EmitTraceOp::DefaultBadTag:
        return "DEFAULT_BAD_TAG";
    case EmitTraceOp::Align:
        return "ALIGN";
    case EmitTraceOp::Pad:
        return "PAD";
    case EmitTraceOp::WriteScalarBool:
        return "WRITE_SCALAR_BOOL";
    case EmitTraceOp::WriteScalarUint:
        return "WRITE_SCALAR_UINT";
    case EmitTraceOp::WriteScalarSint:
        return "WRITE_SCALAR_SINT";
    case EmitTraceOp::WriteScalarFloat:
        return "WRITE_SCALAR_FLOAT";
    case EmitTraceOp::ReadScalarBool:
        return "READ_SCALAR_BOOL";
    case EmitTraceOp::ReadScalarUint:
        return "READ_SCALAR_UINT";
    case EmitTraceOp::ReadScalarSint:
        return "READ_SCALAR_SINT";
    case EmitTraceOp::ReadScalarFloat:
        return "READ_SCALAR_FLOAT";
    case EmitTraceOp::LenCheck:
        return "LEN_CHECK";
    case EmitTraceOp::LenValidate:
        return "LEN_VALIDATE";
    case EmitTraceOp::LenWrite:
        return "LEN_WRITE";
    case EmitTraceOp::LenRead:
        return "LEN_READ";
    case EmitTraceOp::ElemLoop:
        return "ELEM_LOOP";
    case EmitTraceOp::BulkCopy:
        return "BULK_COPY";
    case EmitTraceOp::CompositeInline:
        return "COMPOSITE_INLINE";
    case EmitTraceOp::CompositeDelimHeader:
        return "COMPOSITE_DELIM_HEADER";
    case EmitTraceOp::Advance:
        return "ADVANCE";
    case EmitTraceOp::SectionStart:
        return "SECTION";
    }
    return "UNKNOWN";
}
