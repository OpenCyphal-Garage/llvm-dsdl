...
struct ResolvedTargets final
{
    ...
    /// @brief Explicitly targeted DSDL files (absolute normalised paths).
    ...
    /// @ref explicitTargetFiles alongside a file the user typed -- the two are
    ...
    /// version the user asked for by name alone; this field tells them apart.
    ///
