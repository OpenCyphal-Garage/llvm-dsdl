...
file(WRITE
  ...
  "    reset_modules()\n"
  "\n"
  "    Widget_1_0 = importlib.import_module(f'{PKG}.fixtures.vendor.widget_1_0').Widget_1_0\n"
  ...
  "        f'{PKG}.fixtures.vendor.empty_service_1_0').EmptyService_1_0Request\n"
  "    EmptyServiceResp = importlib.import_module(\n"
  "        f'{PKG}.fixtures.vendor.empty_service_1_0').EmptyService_1_0Response\n"
  "\n"
  "    values = {\n"
  "        'type': Widget_1_0(foo=10, bar=513),\n"
