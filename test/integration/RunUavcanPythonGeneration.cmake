...
foreach(py IN LISTS type_py_files)
  ...
  if(text MATCHES "_union_tag")
    set(found_mlir_union_helper TRUE)
  endif()
  if(text MATCHES "_validate_union_tag")
    set(found_mlir_union_validate_helper TRUE)
  endif()
  if(text MATCHES "= _validate_union_tag[A-Za-z0-9_]*\\(")
    set(found_mlir_union_validate_call TRUE)
  endif()
  if(text MATCHES "_capacity_check")
    set(found_mlir_capacity_check_helper TRUE)
  endif()
  if(text MATCHES "= _capacity_check[A-Za-z0-9_]*\\(")
    set(found_mlir_capacity_check_call TRUE)
  endif()
  if(text MATCHES "_array_length_prefix")
    set(found_mlir_array_prefix_helper TRUE)
  endif()
  if(text MATCHES "= _array_length_prefix[A-Za-z0-9_]*\\(")
    set(found_mlir_array_prefix_call TRUE)
  endif()
  if(text MATCHES "_validate_array_length")
    set(found_mlir_array_validate_helper TRUE)
  endif()
  if(text MATCHES "= _validate_array_length[A-Za-z0-9_]*\\(")
    set(found_mlir_array_validate_call TRUE)
  endif()
  if(text MATCHES "_scalar_unsigned")
    set(found_mlir_scalar_unsigned_helper TRUE)
  endif()
  if(text MATCHES "= _scalar_unsigned[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_unsigned_call TRUE)
  endif()
  if(text MATCHES "_scalar_signed")
    set(found_mlir_scalar_signed_helper TRUE)
  endif()
  if(text MATCHES "= _scalar_signed[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_signed_call TRUE)
  endif()
  if(text MATCHES "_scalar_float")
    set(found_mlir_scalar_float_helper TRUE)
  endif()
  if(text MATCHES "= _scalar_float[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_float_call TRUE)
  endif()
  if(text MATCHES "_validate_delimiter_header")
    set(found_mlir_delimiter_validate_helper TRUE)
  endif()
  if(text MATCHES "= _validate_delimiter_header[A-Za-z0-9_]*\\(")
