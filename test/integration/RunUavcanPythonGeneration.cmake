...
foreach(py IN LISTS type_py_files)
  ...
  if(text MATCHES "mlir_llvmdsdl_plan_union_tag__")
    set(found_mlir_union_helper TRUE)
  endif()
  if(text MATCHES "mlir_llvmdsdl_plan_validate_union_tag__")
    set(found_mlir_union_validate_helper TRUE)
  endif()
  if(text MATCHES "= mlir_llvmdsdl_plan_validate_union_tag__[A-Za-z0-9_]*\\(")
    set(found_mlir_union_validate_call TRUE)
  endif()
  if(text MATCHES "mlir_llvmdsdl_plan_capacity_check__")
    set(found_mlir_capacity_check_helper TRUE)
  endif()
  if(text MATCHES "= mlir_llvmdsdl_plan_capacity_check__[A-Za-z0-9_]*\\(")
    set(found_mlir_capacity_check_call TRUE)
  endif()
  if(text MATCHES "mlir_llvmdsdl_plan_array_length_prefix__")
    set(found_mlir_array_prefix_helper TRUE)
  endif()
  if(text MATCHES "= mlir_llvmdsdl_plan_array_length_prefix__[A-Za-z0-9_]*\\(")
    set(found_mlir_array_prefix_call TRUE)
  endif()
  if(text MATCHES "mlir_llvmdsdl_plan_validate_array_length__")
    set(found_mlir_array_validate_helper TRUE)
  endif()
  if(text MATCHES "= mlir_llvmdsdl_plan_validate_array_length__[A-Za-z0-9_]*\\(")
    set(found_mlir_array_validate_call TRUE)
  endif()
  if(text MATCHES "mlir_llvmdsdl_plan_scalar_unsigned__")
    set(found_mlir_scalar_unsigned_helper TRUE)
  endif()
  if(text MATCHES "= mlir_llvmdsdl_plan_scalar_unsigned__[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_unsigned_call TRUE)
  endif()
  if(text MATCHES "mlir_llvmdsdl_plan_scalar_signed__")
    set(found_mlir_scalar_signed_helper TRUE)
  endif()
  if(text MATCHES "= mlir_llvmdsdl_plan_scalar_signed__[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_signed_call TRUE)
  endif()
  if(text MATCHES "mlir_llvmdsdl_plan_scalar_float__")
    set(found_mlir_scalar_float_helper TRUE)
  endif()
  if(text MATCHES "= mlir_llvmdsdl_plan_scalar_float__[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_float_call TRUE)
  endif()
  if(text MATCHES "mlir_llvmdsdl_plan_validate_delimiter_header__")
    set(found_mlir_delimiter_validate_helper TRUE)
  endif()
  if(text MATCHES "= mlir_llvmdsdl_plan_validate_delimiter_header__[A-Za-z0-9_]*\\(")
