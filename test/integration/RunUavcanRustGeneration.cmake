...
foreach(rs IN LISTS type_rs_files)
  ...
  if(rs_text MATCHES "fn union_tag")
    set(found_mlir_union_helper TRUE)
  endif()
  if(rs_text MATCHES "fn validate_union_tag")
    set(found_mlir_union_validate_helper TRUE)
  endif()
  if(rs_text MATCHES "= validate_union_tag[A-Za-z0-9_]*\\(")
    set(found_mlir_union_validate_call TRUE)
  endif()
  if(rs_text MATCHES "fn capacity_check")
    set(found_mlir_capacity_check_helper TRUE)
  endif()
  if(rs_text MATCHES "= capacity_check[A-Za-z0-9_]*\\(")
    set(found_mlir_capacity_check_call TRUE)
  endif()
  if(rs_text MATCHES "fn array_length_prefix")
    set(found_mlir_array_prefix_helper TRUE)
  endif()
  if(rs_text MATCHES "= array_length_prefix[A-Za-z0-9_]*\\(")
    set(found_mlir_array_prefix_call TRUE)
  endif()
  if(rs_text MATCHES "fn validate_array_length")
    set(found_mlir_array_validate_helper TRUE)
  endif()
  if(rs_text MATCHES "= validate_array_length[A-Za-z0-9_]*\\(")
    set(found_mlir_array_validate_call TRUE)
  endif()
  if(rs_text MATCHES "fn scalar_unsigned")
    set(found_mlir_scalar_unsigned_helper TRUE)
  endif()
  if(rs_text MATCHES "= scalar_unsigned[A-Za-z0-9_]*_deser\\(")
    set(found_mlir_scalar_unsigned_call TRUE)
  endif()
  if(rs_text MATCHES "fn scalar_signed")
    set(found_mlir_scalar_signed_helper TRUE)
  endif()
  if(rs_text MATCHES "= scalar_signed[A-Za-z0-9_]*_deser\\(")
    set(found_mlir_scalar_signed_call TRUE)
  endif()
  if(rs_text MATCHES "fn scalar_float")
    set(found_mlir_scalar_float_helper TRUE)
  endif()
  if(rs_text MATCHES "= scalar_float[A-Za-z0-9_]*_deser\\(")
    set(found_mlir_scalar_float_call TRUE)
  endif()
  if(rs_text MATCHES "fn validate_delimiter_header")
    set(found_mlir_delimiter_validate_helper TRUE)
  endif()
  if(rs_text MATCHES "= validate_delimiter_header[A-Za-z0-9_]*\\(")
