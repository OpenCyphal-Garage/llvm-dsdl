...
///
/// The executable validates randomised and directed behaviour parity for signed
...
fn main() {
    ...
    run_case::<Int3Sat>(
        "vendor.Int3Sat.1.0",
        iterations,
        Int3Sat::SERIALIZATION_BUFFER_SIZE_BYTES,
        c_int3sat_roundtrip,
        int3sat_deserialize,
        int3sat_serialize,
        &mut rng_state,
    ...
    run_case::<Int3Trunc>(
        ...
        iterations,
        Int3Trunc::SERIALIZATION_BUFFER_SIZE_BYTES,
