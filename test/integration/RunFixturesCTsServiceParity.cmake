...
file(WRITE
  ...
  "\n"
  "const reqObj: ${ts_type_module}.DemoService_1_0Request = { req_id: 7, req_vals: [0x1234, 0xabcd] };\n"
  "const reqBytes = ${ts_type_module}.serializeDemoService_1_0Request(reqObj);\n"
  ...
  "const reqDecoded = ${ts_type_module}.deserializeDemoService_1_0Request(reqBytes);\n"
  ...
  "\n"
  "const respObj: ${ts_type_module}.DemoService_1_0Response = { status: 99, result: { x: 42 } };\n"
  "const respBytes = ${ts_type_module}.serializeDemoService_1_0Response(respObj);\n"
  ...
  "const respDecoded = ${ts_type_module}.deserializeDemoService_1_0Response(respBytes);\n"
