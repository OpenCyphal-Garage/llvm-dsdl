...
use dsdl_generated::wire::nar::holder_1_0::Holder as NarHolder;
use dsdl_generated::wire::nar::inner_1_0::Inner as NarInner;
use dsdl_generated::wire::wid::holder_1_0::Holder as WidHolder;
use dsdl_generated::wire::wid::inner_1_0::Inner as WidInner;
