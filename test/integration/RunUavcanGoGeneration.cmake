...
foreach(gf IN LISTS type_go_files)
  ...
  if(go_text MATCHES "[a-z][A-Za-z0-9]*UnionTag")
    set(found_mlir_union_helper TRUE)
  endif()
  if(go_text MATCHES "[a-z][A-Za-z0-9]*ValidateUnionTag")
    set(found_mlir_union_validate_helper TRUE)
  endif()
  if(go_text MATCHES "= [a-z][A-Za-z0-9]*ValidateUnionTag[A-Za-z0-9_]*\\(")
    set(found_mlir_union_validate_call TRUE)
  endif()
  if(go_text MATCHES "[a-z][A-Za-z0-9]*CapacityCheck")
    set(found_mlir_capacity_check_helper TRUE)
  endif()
  if(go_text MATCHES "= [a-z][A-Za-z0-9]*CapacityCheck[A-Za-z0-9_]*\\(")
    set(found_mlir_capacity_check_call TRUE)
  endif()
  if(go_text MATCHES "[a-z][A-Za-z0-9]*ArrayLengthPrefix")
    set(found_mlir_array_prefix_helper TRUE)
  endif()
  if(go_text MATCHES "= [a-z][A-Za-z0-9]*ArrayLengthPrefix[A-Za-z0-9_]*\\(")
    set(found_mlir_array_prefix_call TRUE)
  endif()
  if(go_text MATCHES "[a-z][A-Za-z0-9]*ValidateArrayLength")
    set(found_mlir_array_validate_helper TRUE)
  endif()
  if(go_text MATCHES "= [a-z][A-Za-z0-9]*ValidateArrayLength[A-Za-z0-9_]*\\(")
    set(found_mlir_array_validate_call TRUE)
  endif()
  if(go_text MATCHES "[a-z][A-Za-z0-9]*ScalarUnsigned")
    set(found_mlir_scalar_unsigned_helper TRUE)
  endif()
  if(go_text MATCHES "= [a-z][A-Za-z0-9]*ScalarUnsigned[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_unsigned_call TRUE)
  endif()
  if(go_text MATCHES "[a-z][A-Za-z0-9]*ScalarSigned")
    set(found_mlir_scalar_signed_helper TRUE)
  endif()
  if(go_text MATCHES "= [a-z][A-Za-z0-9]*ScalarSigned[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_signed_call TRUE)
  endif()
  if(go_text MATCHES "[a-z][A-Za-z0-9]*ScalarFloat")
    set(found_mlir_scalar_float_helper TRUE)
  endif()
  if(go_text MATCHES "= [a-z][A-Za-z0-9]*ScalarFloat[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_float_call TRUE)
  endif()
  if(go_text MATCHES "[a-z][A-Za-z0-9]*ValidateDelimiterHeader")
    set(found_mlir_delimiter_validate_helper TRUE)
  endif()
  if(go_text MATCHES "= [a-z][A-Za-z0-9]*ValidateDelimiterHeader[A-Za-z0-9_]*\\(")
