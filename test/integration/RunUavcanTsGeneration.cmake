...
foreach(ts IN LISTS type_ts_files)
  ...
  if(ts_text MATCHES "[A-Za-z0-9]Request" AND ts_text MATCHES "[A-Za-z0-9]Response")
  ...
  if(ts_text MATCHES "unionTag")
    set(found_mlir_union_helper TRUE)
  endif()
  if(ts_text MATCHES "validateUnionTag")
    set(found_mlir_union_validate_helper TRUE)
  endif()
  if(ts_text MATCHES "= validateUnionTag[A-Za-z0-9_]*\\(")
    set(found_mlir_union_validate_call TRUE)
  endif()
  if(ts_text MATCHES "capacityCheck")
    set(found_mlir_capacity_check_helper TRUE)
  endif()
  if(ts_text MATCHES "= capacityCheck[A-Za-z0-9_]*\\(")
    set(found_mlir_capacity_check_call TRUE)
  endif()
  if(ts_text MATCHES "arrayLengthPrefix")
    set(found_mlir_array_prefix_helper TRUE)
  endif()
  if(ts_text MATCHES "= arrayLengthPrefix[A-Za-z0-9_]*\\(")
    set(found_mlir_array_prefix_call TRUE)
  endif()
  if(ts_text MATCHES "validateArrayLength")
    set(found_mlir_array_validate_helper TRUE)
  endif()
  if(ts_text MATCHES "= validateArrayLength[A-Za-z0-9_]*\\(")
    set(found_mlir_array_validate_call TRUE)
  endif()
  if(ts_text MATCHES "scalarUnsigned")
    set(found_mlir_scalar_unsigned_helper TRUE)
  endif()
  if(ts_text MATCHES "= scalarUnsigned[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_unsigned_call TRUE)
  endif()
  if(ts_text MATCHES "scalarSigned")
    set(found_mlir_scalar_signed_helper TRUE)
  endif()
  if(ts_text MATCHES "= scalarSigned[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_signed_call TRUE)
  endif()
  if(ts_text MATCHES "scalarFloat")
    set(found_mlir_scalar_float_helper TRUE)
  endif()
  if(ts_text MATCHES "= scalarFloat[A-Za-z0-9_]*\\(")
    set(found_mlir_scalar_float_call TRUE)
  endif()
  if(ts_text MATCHES "validateDelimiterHeader")
    set(found_mlir_delimiter_validate_helper TRUE)
  endif()
  if(ts_text MATCHES "= validateDelimiterHeader[A-Za-z0-9_]*\\(")
