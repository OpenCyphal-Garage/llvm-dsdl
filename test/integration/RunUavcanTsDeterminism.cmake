...
file(WRITE
  ...
  "#!/bin/sh\n"
  "set -eu\n"
  "env LC_ALL=C TZ=UTC PYTHONHASHSEED=0 \"${DSDLC}\" --target-language ts \"${UAVCAN_ROOT}\" --outdir \"${out_a}\" --ts-module \"uavcan_dsdl_generated_ts\" >\"${OUT_DIR}/run-a.stdout\" 2>\"${OUT_DIR}/run-a.stderr\" &\n"
  "pid_a=$!\n"
  "env LC_ALL=C.UTF-8 TZ=Asia/Tokyo PYTHONHASHSEED=13 \"${DSDLC}\" --target-language ts \"${UAVCAN_ROOT}\" --outdir \"${out_b}\" --ts-module \"uavcan_dsdl_generated_ts\" >\"${OUT_DIR}/run-b.stdout\" 2>\"${OUT_DIR}/run-b.stderr\" &\n"
  "pid_b=$!\n"
  "wait \"$pid_a\"\n"
  "wait \"$pid_b\"\n"
)
