...
file(WRITE
  ...
  "\n"
  "const executeCommandRequest: executeCommand.ExecuteCommand_1_3Request = {\n"
  "  command: executeCommand.EXECUTE_COMMAND_1_3REQUEST_COMMAND_IDENTIFY,\n"
  "  parameter: [65, 66, 67],\n"
  "};\n"
  "const executeCommandRequestBytes = executeCommand.serializeExecuteCommand_1_3Request(executeCommandRequest);\n"
  "console.log(Array.from(executeCommandRequestBytes).join(\" \"));\n"
  "const executeCommandRequestDecoded = executeCommand.deserializeExecuteCommand_1_3Request(executeCommandRequestBytes);\n"
  ...
  "\n"
  "const executeCommandResponse: executeCommand.ExecuteCommand_1_3Response = {\n"
  "  status: executeCommand.EXECUTE_COMMAND_1_3RESPONSE_STATUS_BAD_PARAMETER,\n"
  "  output: [9, 8, 7, 6],\n"
  "};\n"
  "const executeCommandResponseBytes = executeCommand.serializeExecuteCommand_1_3Response(executeCommandResponse);\n"
  "console.log(Array.from(executeCommandResponseBytes).join(\" \"));\n"
  "const executeCommandResponseDecoded = executeCommand.deserializeExecuteCommand_1_3Response(executeCommandResponseBytes);\n"
