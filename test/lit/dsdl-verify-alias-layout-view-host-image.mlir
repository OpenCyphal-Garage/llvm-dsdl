...
module {
  dsdl.schema @test_Inner_1_0 attributes {full_name = "test.Inner", major = 1 : i32, minor = 0 : i32, sealed} {
    dsdl.serialization_plan attributes {aliasable, c_deserialize_symbol = "test__Inner__deserialize_", c_serialize_symbol = "test__Inner__serialize_", c_type_name = "test__Inner", fixed_size, max_bits = 16 : i64, min_bits = 16 : i64, sealed, wire_flat, host_image} {
  ...
  dsdl.schema @test_Holder_1_0 attributes {full_name = "test.Holder", major = 1 : i32, minor = 0 : i32, sealed} {
    dsdl.serialization_plan attributes {c_deserialize_symbol = "test__Holder__deserialize_", c_serialize_symbol = "test__Holder__serialize_", c_type_name = "test__Holder", fixed_size, max_bits = 16 : i64, min_bits = 16 : i64, sealed, wire_flat, host_image} {
