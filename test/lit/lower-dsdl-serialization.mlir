...
// CHECK-DAG: lowered_capacity_check_helper = "llvmdsdl_plan_capacity_check__test_Widget_1_0"
...
// CHECK-DAG: lowered_deser_union_tag_helper = "llvmdsdl_plan_union_tag__test_Widget_1_0__deser"
// CHECK-DAG: lowered_ser_union_tag_helper = "llvmdsdl_plan_union_tag__test_Widget_1_0__ser"
// CHECK-DAG: lowered_union_tag_validate_helper = "llvmdsdl_plan_validate_union_tag__test_Widget_1_0"
...
// CHECK-SAME: lowered_deser_unsigned_helper = "llvmdsdl_plan_scalar_unsigned__test_Widget_1_0__1__deser"
// CHECK-SAME: lowered_ser_unsigned_helper = "llvmdsdl_plan_scalar_unsigned__test_Widget_1_0__1__ser"
// CHECK-SAME: min_bits = 0 : i64
// CHECK-SAME: step_index = 1 : i64
// CHECK-NOT: dsdl.align {bits = 1 : i32
// CHECK-NOT: kind = "padding"
// CHECK: func.func @llvmdsdl_plan_capacity_check__test_Widget_1_0(%[[CAP:[^:]+]]: i64) -> i8 attributes {llvmdsdl.plan_capacity_check
...
// CHECK: return %[[SV]] : i64
// CHECK: func.func @llvmdsdl_plan_scalar_unsigned__test_Widget_1_0__1__deser(%[[DVAL:[^:]+]]: i64) -> i64 attributes {llvmdsdl.scalar_unsigned_helper
// CHECK: %[[DM:[^ ]+]] = arith.andi %[[DVAL]], %[[DMASK:[^ ]+]] : i64
// CHECK: return %[[DM]] : i64
// CHECK: func.func @llvmdsdl_plan_union_tag__test_Widget_1_0__ser(%[[TV:[^:]+]]: i64) -> i64 attributes {
// CHECK-SAME: llvmdsdl.union_tag_helper
// CHECK: %[[TM:[^ ]+]] = arith.andi %[[TV]], %[[TMSK:[^ ]+]] : i64
// CHECK: return %[[TM]] : i64
// CHECK: func.func @llvmdsdl_plan_union_tag__test_Widget_1_0__deser(%[[TDV:[^:]+]]: i64) -> i64 attributes {
// CHECK-SAME: llvmdsdl.union_tag_helper
