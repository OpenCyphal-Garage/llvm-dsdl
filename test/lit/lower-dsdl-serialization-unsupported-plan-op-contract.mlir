...
module {
  dsdl.schema @test_BadPlanOp_1_0 attributes {full_name = "test.BadPlanOp", major = 1 : i32, minor = 0 : i32, sealed} {
    dsdl.serialization_plan attributes {c_deserialize_symbol = "test__BadPlanOp__deserialize_", c_serialize_symbol = "test__BadPlanOp__serialize_", c_type_name = "test__BadPlanOp", max_bits = 8 : i64, min_bits = 0 : i64} {
      dsdl.field {name = "bad", type_name = "uint8"}
