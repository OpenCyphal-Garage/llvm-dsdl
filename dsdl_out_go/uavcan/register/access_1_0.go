...
const ACCESS_REQUEST_FULL_NAME = "uavcan.register.Access.Request"
const ACCESS_REQUEST_IS_DEPRECATED = false
const ACCESS_REQUEST_FULL_NAME_AND_VERSION = "uavcan.register.Access.Request.1.0"
const ACCESS_REQUEST_EXTENT_BYTES = 515
const ACCESS_REQUEST_SERIALIZATION_BUFFER_SIZE_BYTES = 515
const ACCESS_REQUEST_ZOH_ALIAS_ELIGIBLE = false
const ACCESS_REQUEST_ZOH_ALIAS_REASON = "invalid-bit-length"
...
func (obj *Access_Request) Serialize(buffer []byte) (int8, int) {
	if obj == nil {
		return -dsdlruntime.DSDL_RUNTIME_ERROR_INVALID_ARGUMENT, 0
	}
	offsetBits := 0
	mlir_llvmdsdl_plan_capacity_check__uavcan_register_Access_1_0__request := func(capacityBits int64) int8 {
		if 4120 > capacityBits {
			return -dsdlruntime.DSDL_RUNTIME_ERROR_SERIALIZATION_BUFFER_TOO_SMALL
		}
		return dsdlruntime.DSDL_RUNTIME_SUCCESS
	}
	if rc := mlir_llvmdsdl_plan_capacity_check__uavcan_register_Access_1_0__request(int64(len(buffer) * 8)); rc != dsdlruntime.DSDL_RUNTIME_SUCCESS {
		return rc, 0
	}
	for (offsetBits % 8) != 0 {
	...
	_rc10_, _consumed11_ := obj.Value.Serialize(buffer[_start8_:_end9_])
	if _rc10_ < 0 {
		return _rc10_, 0
	}
...
func (obj *Access_Request) Deserialize(buffer []byte) (int8, int) {
	if obj == nil {
		return -dsdlruntime.DSDL_RUNTIME_ERROR_INVALID_ARGUMENT, 0
	}
	...
	_rc14_, _consumed15_ := obj.Name.Deserialize(buffer[_start13_:len(buffer)])
	if _rc14_ < 0 {
		return _rc14_, 0
	}
	...
	_rc17_, _consumed18_ := obj.Value.Deserialize(buffer[_start16_:len(buffer)])
	if _rc17_ < 0 {
		return _rc17_, 0
	}
...
const ACCESS_RESPONSE_FULL_NAME = "uavcan.register.Access.Response"
const ACCESS_RESPONSE_IS_DEPRECATED = false
const ACCESS_RESPONSE_FULL_NAME_AND_VERSION = "uavcan.register.Access.Response.1.0"
const ACCESS_RESPONSE_EXTENT_BYTES = 267
const ACCESS_RESPONSE_SERIALIZATION_BUFFER_SIZE_BYTES = 267
const ACCESS_RESPONSE_ZOH_ALIAS_ELIGIBLE = false
const ACCESS_RESPONSE_ZOH_ALIAS_REASON = "invalid-bit-length"
...
func (obj *Access_Response) Serialize(buffer []byte) (int8, int) {
	if obj == nil {
		return -dsdlruntime.DSDL_RUNTIME_ERROR_INVALID_ARGUMENT, 0
	}
	offsetBits := 0
	mlir_llvmdsdl_plan_capacity_check__uavcan_register_Access_1_0__response := func(capacityBits int64) int8 {
		if 2136 > capacityBits {
			return -dsdlruntime.DSDL_RUNTIME_ERROR_SERIALIZATION_BUFFER_TOO_SMALL
		}
		return dsdlruntime.DSDL_RUNTIME_SUCCESS
	}
	if rc := mlir_llvmdsdl_plan_capacity_check__uavcan_register_Access_1_0__response(int64(len(buffer) * 8)); rc != dsdlruntime.DSDL_RUNTIME_SUCCESS {
		return rc, 0
	}
	for (offsetBits % 8) != 0 {
		_err0_ := dsdlruntime.SetBit(buffer, offsetBits, false)
	...
	_sizeBytes1_ = _consumed5_
	offsetBits += _sizeBytes1_ * 8
	_err6_ := dsdlruntime.SetBit(buffer, offsetBits, obj.Mutable)
	if _err6_ < 0 {
		return _err6_, 0
	}
	offsetBits += 1
	_err7_ := dsdlruntime.SetBit(buffer, offsetBits, obj.Persistent)
	if _err7_ < 0 {
		return _err7_, 0
	}
	offsetBits += 1
	...
	_rc13_, _consumed14_ := obj.Value.Serialize(buffer[_start11_:_end12_])
	if _rc13_ < 0 {
		return _rc13_, 0
	}
...
func (obj *Access_Response) Deserialize(buffer []byte) (int8, int) {
	if obj == nil {
		return -dsdlruntime.DSDL_RUNTIME_ERROR_INVALID_ARGUMENT, 0
	}
	capacityBytes := len(buffer)
	...
	offsetBits = (offsetBits + 7) & ^7
	_start16_ := dsdlruntime.ChooseMin(offsetBits/8, len(buffer))
	_rc17_, _consumed18_ := obj.Timestamp.Deserialize(buffer[_start16_:len(buffer)])
	if _rc17_ < 0 {
		return _rc17_, 0
	}
	offsetBits += _consumed18_ * 8
	obj.Mutable = dsdlruntime.GetBit(buffer, offsetBits)
	offsetBits += 1
	obj.Persistent = dsdlruntime.GetBit(buffer, offsetBits)
	offsetBits += 1
	offsetBits += 6
	offsetBits = (offsetBits + 7) & ^7
	_start19_ := dsdlruntime.ChooseMin(offsetBits/8, len(buffer))
	_rc20_, _consumed21_ := obj.Value.Deserialize(buffer[_start19_:len(buffer)])
	if _rc20_ < 0 {
		return _rc20_, 0
	}
...
type Access = Access_Request

const ACCESS_ZOH_ALIAS_ELIGIBLE = ACCESS_REQUEST_ZOH_ALIAS_ELIGIBLE
const ACCESS_ZOH_ALIAS_REASON = ACCESS_REQUEST_ZOH_ALIAS_REASON
